...
class RandomExpressionGenerator {
    ...
    companion object {
        ...
        val onlyBoolSort: (KFunction<*>) -> Boolean = { it == boolGen } // TODO: Убрать мои изменения из кода?
        val excludeSomeSorts: (KFunction<*>) -> Boolean =
            { it != freshConstGen && it != fpGen && it != arrayGen && it != realGen && it != arrayGen } // TODO: Убрать мои изменения из кода?
        ...
        private class ConstExprGenerator(
            ...
            override fun visit(sort: KUninterpretedSort): AstGenerator<ExprArgument> =
                AstGenerator(
                    constGen.function,
                    constGen.refSortProviders,
                    listOf(SimpleProvider(String::class))
                ) { args ->
                    args + sortArgument
                }
